...
- **Spark It! Activity Database:** 218 activities across 19 categories with properties like duration, energy level, location, cost, spice level, and tips.
  ...
  - **Polyamorous Category (40 activities):** Activities for ethical non-monogamy (ENM) and polyamorous relationships. Focus areas include group communication (10), one-on-one time management (8), communication exercises (7), personal growth (5), and household/nesting partner coordination (10). Addresses unique challenges like scheduling multiple partners, metamour bonding, jealousy processing, compersion practice, and maintaining healthy polycules.
